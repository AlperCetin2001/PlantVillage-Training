...
![Status](https://img.shields.io/badge/Status-Personal_Portfolio-purple)

## 📌 Project Overview
This project is a deep learning initiative designed to detect plant diseases from leaf images with high accuracy and efficiency. By leveraging **Transfer Learning** with the **MobileNetV2** architecture, the system is optimized for mobile and edge devices, making it a practical tool for agricultural diagnostics.

Unlike "Black Box" AI models, this project integrates **Explainable AI (XAI)** using **Grad-CAM**, allowing users to visualize exactly which parts of the leaf the model focuses on when making a diagnosis.
